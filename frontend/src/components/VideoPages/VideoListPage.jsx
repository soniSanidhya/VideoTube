      ...
      // <section class="w-full pb-[70px] sm:ml-[70px] sm:pb-0 lg:ml-0">
        <div class="flex flex-col gap-4 p-4">
          {data?.data.data?.map((video) => (
            <Link to={`/watch/${video._id}`} key={video._id} class="w-full">
            <div class="w-full max-w-3xl gap-x-4 md:flex">
              ...
              <Link to={`/channel/c/${video?.owner.username}`} class="block">
                ...
                <div class="w-full">
                  ...
                  <div class="flex items-center gap-x-4">
                    ...
                    <p class="text-sm text-gray-200">{video.owner.username}</p>
                  </div>
                  </Link>
